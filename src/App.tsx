...
function App() {
  return (
    <>
      <div className="flex flex-col items-center bg-white rounded-lg border border-solid shadow-sm border-stone-20 w-[393px]">
        <Navbar />
        <div className=" flex flex-col items-center w-full p-8">
          ...
          />
          <button className=" px-16 py-4 w-full inline-flex justify-center items-center gap-5 mt-12 text-base font-semibold text-center text-white shadow-sm bg-slate-950 rounded-full">
            Scan Job
            <img
              loading="lazy"
